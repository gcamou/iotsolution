...
namespace WebApi.Extensions
{
    ...
    {
        public static async Task<TDestination> ToResponseAsync<TSource, TDestination>(this Task<TSource> sourceListTask)
        where TSource : IBiz
        ...
        public static async Task<IEnumerable<TDestination>> ToResponseAsync<TSource, TDestination>(this Task<IEnumerable<TSource>> sourceListTask)
        where TSource : IBiz
        where TDestination : class, new()
        {
            var sourceList = await sourceListTask;
        ...
        public static TDestination ToResponse<TSource, TDestination>(this TSource source)
        where TSource : IBiz
        where TDestination : class, new()
        {
            return Map<TSource, TDestination>(source);
        }
        public static IEnumerable<TDestination> ToResponse<TSource, TDestination>(this IEnumerable<TSource> sourceList)
        where TSource : IBiz
        where TDestination : class, new()
        {
            return MapList<TSource, TDestination>(sourceList);
